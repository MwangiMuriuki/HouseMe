...
public class Adapter_HomeTwoBdr extends RecyclerView.Adapter<Adapter_HomeTwoBdr.MyViewHolder> {
    ...
    public Adapter_HomeTwoBdr(List<PropertyInfoModelClass> propertyInfoModelClassList, Context context, FirebaseFirestore firebaseFirestore) {
    ...
    @NonNull
    @Override
    public Adapter_HomeTwoBdr.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View myView = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_recycler_view_layouts, parent, false);

        Adapter_HomeTwoBdr.MyViewHolder myViewHolder = new Adapter_HomeTwoBdr.MyViewHolder(myView);

        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_HomeTwoBdr.MyViewHolder holder, int position) {
