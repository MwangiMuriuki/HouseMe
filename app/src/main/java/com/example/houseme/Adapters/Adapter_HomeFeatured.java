...
public class Adapter_HomeFeatured extends RecyclerView.Adapter<Adapter_HomeFeatured.MyViewHolder> {
    ...
    public Adapter_HomeFeatured(List<PropertyInfoModelClass> propertyInfoModelClassList, Context context, FirebaseFirestore firebaseFirestore) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        Adapter_HomeFeatured.MyViewHolder viewHolder = new Adapter_HomeFeatured.MyViewHolder(myView);
